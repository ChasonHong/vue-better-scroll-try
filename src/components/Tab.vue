      ...
      <div v-if="toggle===1" style="height: 100%">
        <vue-better-scroll
          ...
          <ul ref="list" class="list-content" style="min-height: 95vh">
            <li>tab1</li>
            <router-link :to="{path:'tabs'}" @click.native="jump($event)">
            <li class="list-item" v-for="item in items1">
              
              <p style="width: 220px;height:20px" >{{item}}</p>
            </li>
...
<script>
  import VueBetterScroll from './Bscroll.vue';
